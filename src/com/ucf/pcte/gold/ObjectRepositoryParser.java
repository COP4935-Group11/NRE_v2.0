...
//    System.out.println(Xpath);
  ...
  public static String getXpath (String s,Map<String,Object> variables)
  {
    ...
    Xpath = Xpath.replaceAll(String.valueOf(variables.get(variables.keySet().toArray()[0])), String.valueOf(variables.values().toArray()[0]));
    return Xpath;
  }
